        ...
        <td colspan="12">
            ...
            <div class="table-for-others">
                <table id="example2" style="width:98%;  margin: auto;">
                   <col width="5.46763%" valign="middle">
                        <col width="8.51063%" valign="middle">
                        <col width="19.29363%" valign="middle">
                        <col width="17.94563%" valign="middle">
                    ...
                    <tr>
						...
						<td>
							<div class="tbody-wrapper succeed">
								<p><button class="info-footer-btn btn-others" type="button">1</button></p>
							</div>
						</td>
						<td>
...
`;
		...
		// Ініціалізуємо Select2 для нових елементів
		$(".js-example-responsive3.position-select", row.next()).select2({
			width: 'resolve',
			placeholder: 'Должность',
		});
		
		$(".js-example-responsive3.offices-select", row.next()).select2({
			width: 'resolve',
			placeholder: 'Офис    ',
		});
	});
